...
#ifndef __VCAN_LCD_H__
#define __VCAN_LCD_H__
...
#define  SKY_BLUE     0x05FF	//深天蓝
#define  NAVY_BLUE    16

#define  ORANGE_RED   0xFA20	//橘黄
#define  GOLDEN       65184		//金黄
...
extern void LCD_Img_edge(Site_t site, Size_t size, uint8 *img);
extern void LCD_Img_edge_Z(Site_t site, Size_t size, uint8 *img, Size_t imgsize);
extern void LCD_Img_leftline(Site_t site, Size_t size, uint8 *img);
extern void LCD_Img_rightline(Site_t site, Size_t size, uint8 *img);
...
extern void LCD_Img_gray_Z_CCD(Site_t site, Size_t size, uint8 *img, Size_t imgsize);
