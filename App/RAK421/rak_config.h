...
/*AP */
#define RAK_AP_CHANNEL		  			11	
#define RAK_AP_SSID			     		"RAK411_AP"  
...
#define RAK_SCAN_SSID			 		"rakrak" //"9350aaa"//"theUnburnt"//
/*PSK*/
#define RAK_SET_PSK			     		"68202769"
...
/*NET MODE SELECT*/
#define RAK_NET_MODE			 		NET_AP//NET_STATION//NET_AP//

/*DHCP SELECT*/
#define RAK_DHCP_MODE			 	  	RAK_DHCP_SERVER_ENABLE//RAK_DHCP_CLENT_ENABLE
...
#define  DIST_ADDR		     			"192.168.11.100"
