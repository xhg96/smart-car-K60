...
#if 1             //宏条件编译选择不同的信号类型
ADCn_Ch_e   tsl1401_ch[] = {ADC0_SE16,     ADC0_DP0,    ADC1_DP1};       //CCD所用的 ADC通道(原始信号)
#else
ADCn_Ch_e   tsl1401_ch[] = {ADC0_DM1,     ADC0_DM0,    ADC1_DM1};       //CCD所用的 ADC通道(放大信号)
#endif
PTXn_e      tsl1401_si[] = {PTC19 ,        PTE8 ,       PTE10};          //CCD所用的 SI管脚
PTXn_e      tsl1401_clk[] = {PTC18 ,        PTE9 ,       PTE12};         //CCD所用的 SI管脚
