...
/********************* ST7735R内部实现 ***********************/
//LCD 的管脚定义
#define     LCD_ST7735R_WR      PTA26
#define     LCD_ST7735R_RD      PTB10
#define     LCD_ST7735R_CS      PTA24
#define     LCD_ST7735R_RS      PTA28
#define     LCD_ST7735R_RST     PTA25

//此部分需要修改初始化里的代码
#define     LCD_ST7735R_P0              PTB_B0_OUT
#define     LCD_ST7735R_PIN             PTB_B0_IN
#define     LCD_ST7735R_PDDR_OUT()      (DDRB_B0 = 0xff)
#define     LCD_ST7735R_PDDR_IN()       (DDRB_B0 = 0)
