...
void ANO_DT_Send_Data(u8 *dataToSend , u8 length)
{
	...
	Usb_Hid_Adddata(Data2ANO_Buffer,length);
#endif
#ifdef ANO_DT_USE_USART2
	Usart2_Send(Data2ANO_Buffer, length);
#endif
}

static void ANO_DT_Send_Check(u8 head, u8 check_sum)
{
	Data2ANO_Buffer[0]=0xAA;
	Data2ANO_Buffer[1]=0xAA;
	Data2ANO_Buffer[2]=0xEF;
	Data2ANO_Buffer[3]=2;
	Data2ANO_Buffer[4]=head;
	Data2ANO_Buffer[5]=check_sum;
	
	
	u8 sum = 0;
	for(u8 i=0;i<6;i++)
		sum += Data2ANO_Buffer[i];
	Data2ANO_Buffer[6]=sum;

	ANO_DT_Send_Data(Data2ANO_Buffer, 7);
}
...
void ANO_DT_Send_Version(u8 hardware_type, u16 hardware_ver,u16 software_ver,u16 protocol_ver,u16 bootloader_ver)
{
	...
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0x00;
	Data2ANO_Buffer[_cnt++]=0;
	
	Data2ANO_Buffer[_cnt++]=hardware_type;
	Data2ANO_Buffer[_cnt++]=BYTE1(hardware_ver);
	Data2ANO_Buffer[_cnt++]=BYTE0(hardware_ver);
	Data2ANO_Buffer[_cnt++]=BYTE1(software_ver);
	Data2ANO_Buffer[_cnt++]=BYTE0(software_ver);
	Data2ANO_Buffer[_cnt++]=BYTE1(protocol_ver);
	Data2ANO_Buffer[_cnt++]=BYTE0(protocol_ver);
	Data2ANO_Buffer[_cnt++]=BYTE1(bootloader_ver);
	Data2ANO_Buffer[_cnt++]=BYTE0(bootloader_ver);
	...
	ANO_DT_Send_Data(Data2ANO_Buffer, _cnt);
}
void ANO_DT_Send_Status(float angle_rol, float angle_pit, float angle_yaw, s32 alt, u8 fly_model, u8 armed)
{
	...
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0x01;
	Data2ANO_Buffer[_cnt++]=0;
	
	_temp = (int)(angle_rol*100);
	Data2ANO_Buffer[_cnt++]=BYTE1(_temp);
	Data2ANO_Buffer[_cnt++]=BYTE0(_temp);
	...
	Data2ANO_Buffer[_cnt++]=BYTE3(_temp2);
	Data2ANO_Buffer[_cnt++]=BYTE2(_temp2);
	Data2ANO_Buffer[_cnt++]=BYTE1(_temp2);
	Data2ANO_Buffer[_cnt++]=BYTE0(_temp2);
	
	Data2ANO_Buffer[_cnt++] = fly_model;
	
	Data2ANO_Buffer[_cnt++] = armed;
...
void ANO_DT_Send_RCData(u16 thr,u16 yaw,u16 rol,u16 pit,u16 aux1,u16 aux2,u16 aux3,u16 aux4,u16 aux5,u16 aux6)
{
	...
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0x03;
	Data2ANO_Buffer[_cnt++]=0;
	Data2ANO_Buffer[_cnt++]=BYTE1(thr);
	Data2ANO_Buffer[_cnt++]=BYTE0(thr);
	Data2ANO_Buffer[_cnt++]=BYTE1(yaw);
	Data2ANO_Buffer[_cnt++]=BYTE0(yaw);
	Data2ANO_Buffer[_cnt++]=BYTE1(rol);
	Data2ANO_Buffer[_cnt++]=BYTE0(rol);
	Data2ANO_Buffer[_cnt++]=BYTE1(pit);
	Data2ANO_Buffer[_cnt++]=BYTE0(pit);
	Data2ANO_Buffer[_cnt++]=BYTE1(aux1);
	Data2ANO_Buffer[_cnt++]=BYTE0(aux1);
	Data2ANO_Buffer[_cnt++]=BYTE1(aux2);
	Data2ANO_Buffer[_cnt++]=BYTE0(aux2);
	Data2ANO_Buffer[_cnt++]=BYTE1(aux3);
	Data2ANO_Buffer[_cnt++]=BYTE0(aux3);
	Data2ANO_Buffer[_cnt++]=BYTE1(aux4);
	Data2ANO_Buffer[_cnt++]=BYTE0(aux4);
	Data2ANO_Buffer[_cnt++]=BYTE1(aux5);
	Data2ANO_Buffer[_cnt++]=BYTE0(aux5);
	Data2ANO_Buffer[_cnt++]=BYTE1(aux6);
	Data2ANO_Buffer[_cnt++]=BYTE0(aux6);
...
void ANO_DT_Send_Power(u16 votage, u16 current)
{
	...
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0x05;
	Data2ANO_Buffer[_cnt++]=0;
	
	temp = votage;
	Data2ANO_Buffer[_cnt++]=BYTE1(temp);
	Data2ANO_Buffer[_cnt++]=BYTE0(temp);
	temp = current;
	Data2ANO_Buffer[_cnt++]=BYTE1(temp);
	Data2ANO_Buffer[_cnt++]=BYTE0(temp);
...
void ANO_DT_Send_MotoPWM(u16 m_1,u16 m_2,u16 m_3,u16 m_4,u16 m_5,u16 m_6,u16 m_7,u16 m_8)
{
	...
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0x06;
	Data2ANO_Buffer[_cnt++]=0;
	
	Data2ANO_Buffer[_cnt++]=BYTE1(m_1);
	Data2ANO_Buffer[_cnt++]=BYTE0(m_1);
	Data2ANO_Buffer[_cnt++]=BYTE1(m_2);
	Data2ANO_Buffer[_cnt++]=BYTE0(m_2);
	Data2ANO_Buffer[_cnt++]=BYTE1(m_3);
	Data2ANO_Buffer[_cnt++]=BYTE0(m_3);
	Data2ANO_Buffer[_cnt++]=BYTE1(m_4);
	Data2ANO_Buffer[_cnt++]=BYTE0(m_4);
	Data2ANO_Buffer[_cnt++]=BYTE1(m_5);
	Data2ANO_Buffer[_cnt++]=BYTE0(m_5);
	Data2ANO_Buffer[_cnt++]=BYTE1(m_6);
	Data2ANO_Buffer[_cnt++]=BYTE0(m_6);
	Data2ANO_Buffer[_cnt++]=BYTE1(m_7);
	Data2ANO_Buffer[_cnt++]=BYTE0(m_7);
	Data2ANO_Buffer[_cnt++]=BYTE1(m_8);
	Data2ANO_Buffer[_cnt++]=BYTE0(m_8);
...
void ANO_DT_Send_PID(u8 group,float p1_p,float p1_i,float p1_d,float p2_p,float p2_i,float p2_d,float p3_p,float p3_i,float p3_d)
{
	...
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0xAA;
	Data2ANO_Buffer[_cnt++]=0x10+group-1;
	Data2ANO_Buffer[_cnt++]=0;
